...
public class StrUtils {
	...
	public static String htmlCut(String s, int len, String append) throws org.htmlparser.util.ParserException {
		String text = html2Text(s, len * 2);
		return textCut(text, len, append);
	}

	public static String html2Text(String html, int len) throws org.htmlparser.util.ParserException {
		try {
	 ...
	 */
	/*
	 * 缺少 ik-analyzerjar包 下载地址： https://github.com/wks/ik-analyzer public static
	 * String getKeywords(String keyword, boolean smart) { StringReader reader =
	 * new StringReader(keyword); IKSegmenter iks = new IKSegmenter(reader,
	 * smart); StringBuilder buffer = new StringBuilder(); try { Lexeme lexeme;
	...
	public static void main(String args[]) {
		System.out.println(replaceKeyString("&nbsp;\n</p>"));
		System.out.println("&nbsp;\n</p>");
	}
