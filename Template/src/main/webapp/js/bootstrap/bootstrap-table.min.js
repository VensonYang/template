...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        ajax: undefined,
        cache: true,
        contentType: 'application/x-www-form-urlencoded',//设置提交数据的类型，默认：	'application/json'
        dataType: 'json',
        ajaxOptions: {},
        ...
        sidePagination: 'server', // client or server 默认：client
