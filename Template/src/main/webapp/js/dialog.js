    ...
    CustomDialog.prototype = {
        ...
        initFooter: function () {
            ...
            if (this.option.type != 'basic') {
                html = [
                    this.option.type == 'alert' ? '<span class="btn btn-blue mr170" id="alert-btn">确&#12288;定</span>' :
                    '<span class="btn btn-blue" id="confirm-define">确&#12288;定</span><span class="btn btn-light mr90" id="confirm-cancel">取&#12288;消</span>'
                ].join('');
